...
# the proportional constraint: 25% for Uber, 75% for driver
for i in range(len(matched_result_list)):
    rider = rider_list[matched_result_list[i][1]]
    model_acc.addConstr(s[i] <= 0.25 * PRICE * rider.get_rider_trip_distance)
